...
const DEFAULT_LIGHT: ThemeColorScheme = {
  // 主色 — 蓝灰 slate：沉稳克制，降低视觉疲劳
  primary: '#475569',
  primaryHover: '#566B7F',
  primaryActive: '#364152',
  primaryGradient: 'linear-gradient(135deg, #475569 0%, #566B7F 100%)',
  // 语义色 — 提升辨识度（success 更稳、warning 改 amber、info 去紫味）
  success: '#059669',
  successHover: '#10B981',
...
const DEFAULT_DARK: ThemeColorScheme = {
  // 主色 — 蓝灰 slate（dark 镜像）：在深底上保持辨识度但不再偏冷蓝
  primary: '#8E9EB3',
  primaryHover: '#A6B5C8',
  primaryActive: '#6F7F94',
  primaryGradient: 'linear-gradient(135deg, #8E9EB3 0%, #A6B5C8 100%)',
  // 语义色 — dark 模式亮一档，让色彩在深底上鲜明
  success: '#34D399',
  successHover: '#6EE7B7',
...
const DEFAULT_LIGHT_NEUTRAL: NeutralColors = {
  ...
  borderLight: '#EFEDE8',
  borderDark: '#D0CEC7',
  // 护眼米色：极淡暖调（R≈G 略 > B），长时间盯看不刺眼但不显黄
  background: '#F2F1ED',
  backgroundCard: '#F8F7F4',
  backgroundToolbar: '#EFEEEA',
  backgroundHover: '#ECEAE5',
  backgroundActive: '#E8E7E2',
  mask: 'rgba(0, 0, 0, 0.3)',
  windowBackground: '#F2F1ED',
  rowHoverBg: '#ECEAE5',
  rowSelectedBg: '#E2E0DA',
...
const DEFAULT_DARK_NEUTRAL: NeutralColors = {
  ...
  borderLight: '#252932',
  borderDark: '#3A4049',
  // 背景层次 — Linear 风：深蓝灰基底，卡片/工具栏/悬浮逐级浮起
  background: '#1A1D23',
  backgroundCard: '#23262E',
  backgroundToolbar: '#1F2228',
  backgroundHover: '#2C2F37',
  backgroundActive: '#3A4049',
  mask: 'rgba(0, 0, 0, 0.6)',
  windowBackground: '#1A1D23',
  rowHoverBg: '#2C2F37',
  rowSelectedBg: '#3D4452',
  rowStripeBg: 'rgba(255, 255, 255, 0.015)',
  headerBg: '#1F2228',
...
const DEFAULT_GLASS_DARK: GlassEffect = {
  glassBackground: 'rgba(35, 38, 46, 0.72)',
  glassBorder: 'rgba(255, 255, 255, 0.06)',
  glassBlur: 'blur(20px)',
  glassShadow: '0 8px 32px rgba(0,0,0,0.5), 0 0 0 0.5px rgba(255,255,255,0.04)',
  glassInnerGlow: 'inset 0 1px 0 rgba(255,255,255,0.04)',
...
const DEFAULT_SHADOWS = {
  ...
  // dark 阴影：只保留外阴影（卡片浮起物理感），移除 inset 高光（避免 WebView 文字发虚）
  cardShadowDark: '0 1px 2px rgba(0,0,0,0.3), 0 6px 16px rgba(0,0,0,0.4)',
  headerShadowDark: '0 1px 2px rgba(0,0,0,0.35), 0 4px 12px rgba(0,0,0,0.45)',
  // glow 跟随 slate 主色 #8B95A7 (light) / #8E9EB3 (dark) → RGB(139,149,167)
  glowPrimary: '0 0 24px rgba(139,149,167,0.14)',
  glowPrimarySoft: '0 0 36px rgba(139,149,167,0.10), 0 0 72px rgba(139,149,167,0.04)',
  glowPrimaryStrong: '0 0 48px rgba(139,149,167,0.22), 0 0 96px rgba(139,149,167,0.08)',
};
...
const MODERN_LIGHT_NEUTRAL: NeutralColors = {
  ...
  borderLight: '#EFEDE8',
  borderDark: '#D6D4CE',
  // 背景层级 — 护眼米色基调（同 default 策略），青碧色调的激活/选中态
  background: '#F1F0EC',
  backgroundCard: '#F7F6F3',
  backgroundToolbar: '#EEEEE9',
  backgroundHover: '#EAE9E4',
  backgroundActive: '#DCEFEB',
  mask: 'rgba(0, 0, 0, 0.25)',
  windowBackground: '#F1F0EC',
  rowHoverBg: '#EAE9E4',
  rowSelectedBg: '#DCEFEB',
  rowStripeBg: 'rgba(0, 0, 0, 0.01)',
  headerBg: '#EFEEE9',
  surfaceElevated: '#FBFAF7',
  scrollbarThumb: 'rgba(0, 0, 0, 0.09)',
  scrollbarTrack: 'rgba(0, 0, 0, 0.014)',
...
const MODERN_DARK_NEUTRAL: NeutralColors = {
  ...
  borderLight: '#25282B',
  borderDark: '#393C40',
  // 背景层级 — Linear 风：深蓝灰基底，卡片/工具栏/悬浮逐级浮起
  background: '#1B1E22',
  backgroundCard: '#24272C',
  backgroundToolbar: '#202328',
  backgroundHover: '#2E3237',
  backgroundActive: '#1A3A35',
  mask: 'rgba(0, 0, 0, 0.6)',
  windowBackground: '#1B1E22',
  rowHoverBg: '#2E3237',
  rowSelectedBg: '#1A3A35',
  rowStripeBg: 'rgba(255, 255, 255, 0.012)',
  headerBg: '#202328',
  surfaceElevated: '#2B2E33',
  scrollbarThumb: 'rgba(255, 255, 255, 0.12)',
  scrollbarTrack: 'rgba(255, 255, 255, 0.025)',
  // 层级过渡 — 底层到卡片跃升，之后逐级收敛
  level1: '#1B1E22',
  level2: '#24272C',
  level3: '#2B2E33',
...
const INK_LIGHT_NEUTRAL: NeutralColors = {
  ...
  borderLight: '#E8E8E8',
  borderDark: '#C2C2C2',
  // 背景层级 — 柔和灰白（非纯白），长时间盯看不刺眼
  background: '#EDEDED',
  backgroundCard: '#F4F4F4',
  backgroundToolbar: '#EAEAEA',
  backgroundHover: '#E4E4E4',
  backgroundActive: '#DCDCDC',
  mask: 'rgba(0, 0, 0, 0.35)',
  windowBackground: '#EDEDED',
  rowHoverBg: '#E4E4E4',
  rowSelectedBg: '#D5D5D5',
  rowStripeBg: 'rgba(0, 0, 0, 0.015)',
  headerBg: '#E9E9E9',
